...
Literate.markdown("examples/src/ex5_Afrouzi_Yang_2019.jl", "docs/src/examples/ex5_ay2020"; documenter=true, execute = true, codefence = "```julia" => "```")
...
Literate.notebook("examples/src/ex5_Afrouzi_Yang_2019.jl", "examples/notebooks"; documenter=true, preprocess = update_notebooks)
